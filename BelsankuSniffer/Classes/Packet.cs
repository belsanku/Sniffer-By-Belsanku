...
namespace BelsankuSniffer
{
    public class Packet
    {
        ...
        public Packet(byte[] raw)
        {
            ...
            raw_Packet = raw;
            dateTime = DateTime.Now; // Время захвата пакета
            headLength = (raw[0] & 0x0F) * 4;  // Длина заголовка

            if ((raw[0] & 0x0F) < 5)
                throw new ArgumentException(); // Ошибка в заголовке
